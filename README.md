...
sequenceDiagram
    ...
    activate server
    server-->>browser: [{"content": "new note content", "date": "2026-09-18"}, ...]
    deactivate server
...
sequenceDiagram
    ...
    activate server
    server-->>browser: [{"content": "HTML is easy", "date": "2026-09-18"}, ...]
    deactivate server
...
sequenceDiagram
    ...
    Note right of browser: The browser adds the new note to the list and re-renders the page locally
    ...
    activate server
    Note over browser,server: Payload (JSON): {"content": "new note content", "date": "2026-09-18"}
